...
; Skriver ut sifferet lagret i ecx. Ingen sjekk på verdiområde.
	...
	cmp ecx, 10 ;Sjekker om ecx(tallet) er høyere enn 10(2-siffer)
	v ebx, ecx ; tar vare på opprinnelig sum
	mov ecx, 1 ;flytter tallet 1 inn i ecx
	call skrivsiffer ;skriver ut 1
	sub ebx, 10 ;trekker fra 10 i opprinnelig sum
	mov ecx, ebx 
;legger summen-10 i ecx og legger til det tallet ved siden av 1

ensiffer: ;Hjelpemetode dersom summen er større enn 9
	add ecx,'0'; konverterer tall til ascii.
	mov [siffer],ecx
	mov ecx,siffer
	mov edx,1
	mov ebx,STDOUT
...
je Lokke
cmp ecx,'0'
; Sjekk at tast er i område 0-9
jb Feil
cmp ecx,'9'
ja Feil
sub ecx,'0'
; Konverter ascii til tall.
...
mov ebx,STDOUT
mov eax,SYS_WRITE
int 80hjb ensiffer ;hopper til tosiffer
	mo
pop edx
pop ecx
pop ebx
